...
export class Categorias implements OnInit, OnDestroy {
  ...
  async loadCategorias() {
    ...
    try {
      const response = await this.categoriasService.getCategorias({
        page: this.page,
        limit: this.limit,
  ...
  async saveCategoria() {
    ...
    if (this.editingCategoria) {
      ...
      try {
        const data = await this.categoriasService.updateCategoria(this.editingCategoria.id, this.formData);
      ...
      try {
        const data = await this.categoriasService.createCategoria(this.formData);
  ...
  async toggleActivo(categoria: CategoriaEvento) {
    try {
      await this.categoriasService.updateCategoria(categoria.id, { activo: !categoria.activo });
      this.loadCategorias();
    } catch (err) {
